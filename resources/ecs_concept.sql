...
SELECT utterance AS UTT, concept.sctid AS SCTID, name AS TERM FROM ec_concepts, eligibility_criteria, concept WHERE 
...
ec_concepts.concept_sctid = concept.sctid AND concept.sctid = "424144002";