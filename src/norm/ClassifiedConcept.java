...
/**
 * <p>Clase Java para classifiedConcept complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="classifiedConcept">
 *   &lt;complexContent>
...
@XmlType(name = "classifiedConcept", namespace = "http://CoreDataset/xsd", propOrder = {
    "attribute",
    "code",
    "label",
    "table"
...
public class ClassifiedConcept {
    ...
    @XmlElementRef(name = "attribute", namespace = "http://CoreDataset/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "label", namespace = "http://CoreDataset/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> label;
    @XmlElementRef(name = "table", namespace = "http://CoreDataset/xsd", type = JAXBElement.class, required = false)
